...
function randomQuotesForSchedule() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            do {
                ...
                const response = yield docClient.send(new lib_dynamodb_1.ScanCommand(params));
        ...
        for (const item of allGuildInfo) {
            const channel = yield client.channels.fetch(item.ChannelID);
            ...
            docClient.send(command, function (err, data) {
                return __awaiter(this, void 0, void 0, function* () {
                    if (err || data.Count === 0) {
                        ...
                        if (data.Count === 0) {
                            yield channel.send({ content: 'No quote was found....' });
...
function scheduleDailyPosts(targetHour_1) {
    return __awaiter(this, arguments, void 0, function* (targetHour, targetMinute = 0) {
        const now = new Date();
