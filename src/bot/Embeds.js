...
const helpEmbed = new EmbedBuilder()
  ...
  .addFields(
    { name: '/setautopostchannel', value: 'set a channel in your server to auto post a quote everyday at noon! (must have admin/mod privileges, and must be a text channel)\n' },
